...
function StaffDetail() {
    ...
    const callEmpPage = async () =>{
        try{
            ...
            const res = await fetch("/StaffDetail/"+id, {
                method :"GET",
                headers:{
            ...
            console.log("Staff Detail History Page")
            setUserData(data);
            if(!res.status === 201){
            ...
            <div className="customerDetail">
                ...
                <form method="GET">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Staff ID<span className="float-right">{userData._id}</span></li>
                        <li class="list-group-item">Name <span className="float-right">{userData.firstname}</span></li>
                        <li class="list-group-item">Gender <span className="float-right">{userData.gender}</span></li>
                        <li class="list-group-item">Phone Number<span className="float-right">{userData.phone_no}</span></li>
                        <li class="list-group-item">Email<span className="float-right">{userData.email}</span></li>
                        <li class="list-group-item">Designation<span className="float-right">{userData.designation}</span></li>
